...
func (m *Annex) GetContractId() uint64 {
	if m != nil {
		return m.ContractId
	}
	return 0
...
var fileDescriptor_4bd2cabf34eecf92 = []byte{
	...
	,
}
...
func (m *Annex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ContractId != 0 {
		i = encodeVarintAnnex(dAtA, i, uint64(m.ContractId))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Annex) Size() (n int) {
	...
	if m.ContractId != 0 {
		n += 1 + sovAnnex(uint64(m.ContractId))
	}
	l = len(m.State)
	if l > 0 {
		n += 1 + l + sovAnnex(uint64(l))
